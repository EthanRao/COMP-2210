...
public final class Point implements Comparable<Point> {
  ...
  /** Compare two points with respect to the slope each makes with this point. */
   ...
   public double slopeTo(Point that) {
      double ySlope = (((double) that.y) - ((double) this.y));
      double xSlope = (((double) that.x) - ((double) this.x));
      double value = (ySlope / xSlope);
      if ((((double) this.x) != ((double) that.x)) && (((double) this.y) == ((double) that.y))) {
         value = 0;
      }
      else if ((((double) this.x) == ((double) that.x)) && (((double) this.y) != ((double) that.y))) {
